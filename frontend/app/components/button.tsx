...
const buttonStyle = ({
	...
	const style = {
		...
		iconColor: {
			base: '[&_svg[data-ui=icon]:not([class*=text-])]:text-[var(--icon-color)]',
			solid: !isIconOnly && '[--icon-color:var(--btn-color)]',
			outline: !isIconOnly && '[--icon-color:var(--btn-color)]',
			plain: !isIconOnly && '[--icon-color:var(--btn-color)]',
