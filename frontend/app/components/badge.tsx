...
export function Badge({ className, solid, color = 'zinc', ...props }: BadgeProps) {
	return (
		<span
			{...props}
			{...(solid && {
			...
			data-ui='badge'
			className={twMerge(
				'inline-flex max-w-fit items-center gap-x-1 text-nowrap rounded-md px-2 py-0.5 font-medium text-xs/5',
